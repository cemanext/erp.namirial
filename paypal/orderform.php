...
<html>
<head>
<title>::Eduvirama PayPal :: Order Form::</title>
</head>
  ...
  <tr>
      ...
      <table width="223" border="0">
        <tr> 
          <td> <p>Apellidos:  
            ...
            <table width="223" border="0" style="display: none">
               <tr> 
                  <td> <p> Direccion 1: 
      ...
      <table width="223" border="0" style="display: none">
        <tr> 
          <td> <p>Zip: 
            ...
            <table width="223" border="0"  style="display: none">
               <tr> 
                  <td height="16" align="left" valign="top"> Telefono: <table width="223" border="0" cellpadding="0" cellspacing="0">
                        <tr> 
    ...
    <td align="left" valign="top"><table width="223" border="0">
      ...
      <table width="223" border="0" style="display: none">
        <tr> 
          <td> <p>Quantity: 
                        <input name="quantity" type="text" id="quantity" size="40" value="1">
            </p></td>
        </tr>
      </table>
      <table width="223" border="0" style="display: none">
