<?php
define('WP_DOMAIN_NAME', 'http://demo.XXXXXXXXXX.com');
/*
 * config.inc.php
 *
...
$paypal[business]="";
$paypal[site_url]="".WP_DOMAIN_NAME."";
$paypal[image_url]="".WP_DOMAIN_NAME."/wp-content/uploads/2017/07/logo-beta.png";
//$paypal[success_url]="php_paypal/conferma.php";
$paypal[success_url]="/carrello/conferma-ordine";
//$paypal[success_url]="php_paypal/ipn/ipn.php";
$paypal[cancel_url]="/carrello/ordine-annullato";
