...
include_once(BASE_ROOT . 'moduli/carrello/funzioni.php');
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE HEADER-->
                    <?php Stampa_HTML_index_Ordini($tabella); ?>
...
<!--<script src="<?= BASE_URL ?>/assets/apps/scripts/todo-2.min.js" type="text/javascript"></script>-->
        ...
        <script src="<?= BASE_URL ?>/moduli/carrello/scripts/funzioni.js" type="text/javascript"></script>
