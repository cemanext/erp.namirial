...
if (isset($_POST['intervallo_data'])) {
    ...
    $where_intervallo = " AND lista_ordini.dataagg BETWEEN  '" . $data_in . "' AND  '" . $data_out . "'";
    $titolo_intervallo = " dal  " . $data_in . " al  " . $data_out . "";
    //echo '<h1>$intervallo_data = '.$intervallo_data.'</h1>';
} else {
    $where_intervallo = " AND YEAR(lista_ordini.dataagg)=YEAR(CURDATE()) AND MONTH(lista_ordini.dataagg)=MONTH(CURDATE())";
                ...
                <div class="page-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group" id="defaultrange" name="defaultrange">
                                                <input type="text" class="form-control" id="intervallo_data" name="intervallo_data">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <?php
                            $sql_007 = "SELECT SUM(imponibile) AS conteggio FROM lista_ordini WHERE stato LIKE 'In Attesa' " . $where_intervallo;
                            $titolo = 'Totale Ordini Shop In Attesa<br>' . $titolo_intervallo;
                            $icona = 'fa fa-line-chart';
                            $colore = 'yellow-lemon';
                            $link = '/moduli/preventivi/index.php?tbl=lista_ordini&idMenu=16';
                            stampa_dashboard_stat_v2($sql_007, $titolo, $icona, $colore, $link)
                            ?>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <?php
                            $sql_007 = "SELECT SUM(imponibile) AS conteggio FROM lista_ordini WHERE stato LIKE 'Chiuso' " . $where_intervallo;
                            $titolo = 'Totale Ordini Shop Chiusi<br>' . $titolo_intervallo;
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <?php
                            $sql_007 = "SELECT SUM(imponibile) AS conteggio FROM lista_ordini WHERE stato LIKE 'Venduto' " . $where_intervallo;
                            $titolo = 'Totale Ordini Shop Venduti<br>' . $titolo_intervallo;
                            $icona = 'fa fa-area-chart';
                            $colore = 'blue';
                            $link = '/moduli/preventivi/index.php?tbl=lista_ordini&idMenu=16';
                            stampa_dashboard_stat_v2($sql_007, $titolo, $icona, $colore, $link)
                                                    ...
                                                    <div class="portlet-body">
                                                        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="tab1_per_commessa">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                FROM lista_ordini 
                                                                WHERE 1 " . $where_intervallo . " ORDER BY dataagg DESC";
                                                                $rs_001 = $dblink->get_results($sql_001);
                                                                if (!empty($rs_001)) {
                                                                    //$conteggio_001 = count($rs_001);
