...
include_once(BASE_ROOT . 'moduli/provvigioni/funzioni.php');
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <!-- INIZIO TABELLA-->
                            <?php stampa_bootstrap_form_horizontal($tabella,$id,'Modifica', BASE_URL.'/moduli/provvigioni/salva.php?fn=salvaGeneraleProvvigioni');?>
                            <!-- FINE TABELLA-->
                        </div>
