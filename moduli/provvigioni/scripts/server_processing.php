    ...
    case "lista_provvigioni":
        ...
        if(!empty($arrayCampoRicerca)){
            foreach ($arrayCampoRicerca as $campoRicerca) {
                $where.= " AND (codice LIKE '%".$campoRicerca."%' OR `nome` LIKE '%".$campoRicerca."%'";
                $where.= " OR `descrizione` LIKE '%".$campoRicerca."%' OR `nome_prodotto` LIKE '%".$campoRicerca."%'";
                $where.= " OR `prezzo_prodotto` LIKE '%".$campoRicerca."%' OR `prezzo_sconto` LIKE '%".$campoRicerca."%'";
                $where.= " OR `provvigione` LIKE '%".$campoRicerca."%' OR `provvigione_percentuale` LIKE '%".$campoRicerca."%')";
            }
        }
