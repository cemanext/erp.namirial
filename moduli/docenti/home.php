                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <?php
                            $sql_007 = "SELECT COUNT(id) AS conteggio FROM lista_docenti WHERE MONTH(data_inizio)=MONTH(CURDATE()) AND YEAR(data_inizio)=YEAR(CURDATE())";
                            $titolo = 'lista_docenti del Mese';
                            $icona = 'fa fa-graduation-cap';
                            $colore = 'green-meadow';
                            $link = '/moduli/docenti/index.php?tbl=lista_docenti&idMenu=59';
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <?php
                            $sql_007 = "SELECT COUNT(*) AS conteggio FROM lista_docenti WHERE YEAR(data_inizio_iscrizione)=YEAR(CURDATE()) AND (stato LIKE 'In Attesa' OR stato LIKE 'In Corso')";
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <?php
                            $sql_007 = "SELECT COUNT(id) AS conteggio FROM lista_docenti_dettaglio WHERE MONTH(data_completamento)=MONTH(CURDATE()) AND YEAR(data_completamento)=YEAR(CURDATE())";
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <?php
                            $sql_007 = "SELECT COUNT(id) AS conteggio FROM lista_docenti_dettaglio WHERE YEAR(data_completamento)=YEAR(CURDATE())";
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <?php
                            $sql_007 = "SELECT COUNT(stato) as conteggio FROM `lista_docenti` WHERE 1 AND stato='In Attesa' GROUP BY stato";
                            $titolo = 'Totale Corsi - In Attesa';
                            $icona = 'fa fa-users';
                            $colore = 'yellow-saffron';
                            $link = '/moduli/docenti/index.php?tbl=table_listaIscrizioniInAttesa&idMenu=105';
                            stampa_dashboard_stat_v2($sql_007, $titolo, $icona, $colore, $link);
                            ?>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <?php
                            $sql_007 = "SELECT COUNT(stato) as conteggio FROM `lista_docenti` WHERE 1 AND stato='In Corso' GROUP BY stato";
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <?php
                            $sql_007 = "SELECT COUNT(stato) as conteggio FROM `lista_docenti` WHERE 1 AND stato='Completato' GROUP BY stato";
                            $titolo = 'Totale Corsi - Completati';
                            $icona = 'fa fa-users';
                            $colore = 'green-jungle';
                            $link = '/moduli/docenti/index.php?tbl=table_listaIscrizioniCompletati&idMenu=106';
                            stampa_dashboard_stat_v2($sql_007, $titolo, $icona, $colore, $link);
                        ?>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <?php
                            $sql_007 = "SELECT COUNT(*) as conteggio FROM `lista_docenti` WHERE 1 AND stato='Configurazione'";
                        ...
                        ?>
                            ...
                            <?php
                            $sql_007 = "SELECT COUNT(*) as conteggio FROM `lista_docenti` WHERE 1 AND stato LIKE 'Configurazione Scadut%'";
                            ...
                            <div class="col-md-6 col-sm-6">
                            <?php
                            $sql_007 = "SELECT COUNT(*) as conteggio FROM `lista_docenti` WHERE abbonamento='0' AND stato LIKE 'Scaduto e Disattivato'";
