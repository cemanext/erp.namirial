...
include_once(BASE_ROOT . 'moduli/docenti/funzioni.php');
...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-fixed">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE TITLE -->
                    <!-- END PAGE HEADER-->
                    <?php Stampa_HTML_index_Docenti($tabella); ?>
        ...
        <script src="<?= BASE_URL ?>/moduli/docenti/scripts/funzioni.js" type="text/javascript"></script>
