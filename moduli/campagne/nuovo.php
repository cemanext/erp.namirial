...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript">
            function eliminaFattura(idDelFatt) {
                if (confirm("SEI SICURO DI VOLER ELIMINARE LA FATTURA ?")) {
                    document.location = 'indexRecord.php?tbl=lista_fatture&idDelFatt=' + idDelFatt;
                }
            }
        </script>
    </head>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-fixed">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <!-- INIZIO TABELLA-->
                            <?php Stampa_HTML_Form_Campi_Modificabili($tabella,$id); ?>
                            <!-- FINE TABELLA-->
                        </div>
        ...
        <script src="<?= BASE_URL ?>/assets/apps/scripts/apps_configurazione.js" type="text/javascript"></script>
