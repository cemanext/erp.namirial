...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript">
            function SelezTT() {
                var i = 0;
                var fEsporta = document.fEsporta.elements;
                for (i = 0; i < fEsporta.length; i++)
                {
                    if (fEsporta[i].type == "checkbox")
                    {
                        fEsporta[i].checked = true;
                    }
                }
            }
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <!-- INIZIO TABELLA-->
                            <?php
                            stampa_bootstrap_form_esporta($tabella, $id, 'Filtra', "esporta.php?tbl=$tabella&idMenu=" . $_GET['idMenu']);
                            ?>
                            <!-- FINE TABELLA-->
                        </div>
                    </div>
