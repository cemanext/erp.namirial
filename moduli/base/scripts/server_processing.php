    ...
    case "lista_password":
        ...
        if(!empty($arrayCampoRicerca)){
            foreach ($arrayCampoRicerca as $campoRicerca) {
                ...
                $where.= " OR username LIKE '%".$campoRicerca."%' OR email LIKE '%".$campoRicerca."%'";
                $where.= " OR data_creazione LIKE '%".$campoRicerca."%' OR data_ultimo_accesso LIKE '%".$campoRicerca."%'";
    ...
    case "lista_password_utenti":
        ...
        if(!empty($arrayCampoRicerca)){
            foreach ($arrayCampoRicerca as $campoRicerca) {
                ...
                $where.= " AND (cognome LIKE '%".$campoRicerca."%' OR nome LIKE '%".$campoRicerca."%'";
                $where.= " OR username LIKE '%".$campoRicerca."%' OR email LIKE '%".$campoRicerca."%'";
                $where.= " OR id_moodle_user LIKE '%".$campoRicerca."%'";
                $where.= " OR data_creazione LIKE '%".$campoRicerca."%' OR data_ultimo_accesso LIKE '%".$campoRicerca."%'";
                $where.= " OR data_scadenza LIKE '%".$campoRicerca."%' OR stato LIKE '%".$campoRicerca."%')";
            }
        }
