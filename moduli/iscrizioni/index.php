...
if(isset($tabella) && ($tabella=="lista_iscrizioni_partecipanti_completati" or $tabella=="lista_iscrizioni_configurazioni")){
    if (!empty($_GET['intervallo_data'])) {
        ...
        $titolo_intervallo = " del mese in corso";
        $_SESSION['intervallo_data_iscrizioni'] = "01-".date("m-Y")." al ".date("t-m-Y");
        $_GET['intervallo_data'] = "01-".date("m-Y")." al ".date("t-m-Y");
        $setDataCalIn = "01-".date("m-Y");
        $setDataCalOut = date("t-m-Y");
    }
}else{
    $_SESSION['intervallo_data_iscrizioni'] = null;
    unset($_SESSION['intervallo_data_iscrizioni']);
}
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE TITLE -->
                    <!-- END PAGE HEADER-->
                    <?php Stampa_HTML_index_Iscrizioni($tabella); ?>
