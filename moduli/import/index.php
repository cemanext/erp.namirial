...
include_once(BASE_ROOT . 'moduli/import/funzioni.php');
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <?php Stampa_HTML_index_Import($tabella); ?>
...
<!--<script src="<?= BASE_URL ?>/assets/apps/scripts/todo-2.min.js" type="text/javascript"></script>-->
        ...
        <script src="<?= BASE_URL ?>/moduli/import/scripts/funzioni.js" type="text/javascript"></script>
