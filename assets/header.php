...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <form class="search-form search-form-expanded" action="<?= BASE_URL ?>/risultatiRicerca.php" method="POST">
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Cerca..." id="cercaQualcosa" name="cercaQualcosa">
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        ...
                        <li>
                            <a href="#">
                                <i class="icon-calendar"></i> Richieste </a>
                        </li>
                        <li>
                            <a href="#">
